...
#Class init method to initialize real and imaginary parts of a complex number
...
#Overloading the '*' operator
  def __mul__(self, other):
    ...
    self.imag = self.imag * other.imag
    return self
#Method to return a string representation of the complex number in the format real + imag
  def __str__(self):
    if self.imag == 0:
