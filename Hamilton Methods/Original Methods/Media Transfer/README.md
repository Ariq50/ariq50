METHOD FOR ALIQUOTING PRE-SET VOLUME OF MEDIA FROM TROUGH TO TUBES:
...
The next group of four tube carriers is then aliquoted to and unloaded from the deck, followed by the final group of four tube carriers. 

At the end of the run, a series of mapping files are generated, each associated with a separate tube carrier sequence.
